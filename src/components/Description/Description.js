...
},
{
    ...
    content: "Using Natural language processing, we can extract key words from the original article to produce a concise summary of the article. It is not perfect, but it exciting to try."
}]
